...
I have outlined in a [different post](https://marcoguerri.github.io/2023/08/26/reverse-engineering-msdos.html) how the binary can be unpacked to obtain code Ghida and IDA can disassemble.
